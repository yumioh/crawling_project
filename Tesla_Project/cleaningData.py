...
stop_words = ['월', '위', '일', '억', '년', '원', '지난해', '를', '것', '등','차','올해','챗','위', '가', '조', '의', '및','약','수','주',
              '만','이','중','말','마하','미','거','게','고','분','때문','때','더','점','씨','전','개','디','은','론','닉','키','김','책','그',
              '팀','스케','용','닉스', '이번', '그룹', '현지', '로이터', '전국', '루', '중이', '경찰', '자기', '확인', '운동', '남성', '청원', '창',      
              ...
              '로', '달', '대표', '업체', '사업', '미래','계획', '세계','시간', '예상', '사', '로', '볼', '걸', '수도', '저',
              '기존', '통해', '관련', '현재', '지난', '시장', '카', '차량', '협업', '서명', '바이', '산', '파이낸셜 뉴스',
              '대로', '전체', '고객', '공개', '서울', '이상', '아이오', '적용', '예정', '상황', '얘기', '정도', '안', '사실', '사람',
              '예스', '교수', '게임', '아이', '선', '대비', '며', '업종', '뉴시스', '하나', '경우', '재개', '부분', '가지', '계속', '오늘',
              ...
              '최근', '요', '와이드', '지리', '목표', '순', '나', '유', '튜버', '러너', '하임', '자', '단독',
              '위', '가', '조', '의', '및', '만','이','중','말','마하','미','거','게','고','분','때문','때','더','점','씨','전','개',
              '디', '키', '타카히로', '하치', '도널드', '트럼프', '유명', '신년', '것', '이달', '일', '이번',  '명',
              '영미', '뉴스', '등', '후', '시작', '텍', '유현석', '기자', '센트랄', '카', '넷', '전년', '지난해', '종류', '테크', '나우',
              '팀','스케','용','닉스', '이번', '그룹', '현지', '로이터', '전국', '루', '중이', '경찰', '자기', '확인', '운동', '남성', '청원', '창',
              '확', '집', '전달', '토크', '륜', '의학', '거주', '곳', '소', '기', '재', '하이', '초', '공간', '배포', '총','무단', '이마트', '대구',
              '저작권', '강동', '수다', '뉴스', '줌', '텍사스', '헬', '대신', '텍', '텍사스주','중산', '생수', '엠씨',
              '플로리다', '캘리포니아주', '약관', '본사', '건', '장기', '감염증', '캐릭터', '달이', '김혜민','순', '발', '스틱',
              '마스터', '산', '강원도', '부분', '주인', '알렉스', '제', '보', '로직', '루다', '중산', '생수', '엠씨',
              '선', '타이', '커피', '에브리싱', '명의', '베이커', '크루', '스프링', '완', '타고', '세션',
              '개사', '만점', '대성', '데일리안', '킥', '수단', '부문', '플라잉', '별', '날', '장',  '행차', '기록', '백화점', '대비',
              '로', '달', '대표', '업체', '사업', '미래','계획', '세계', '회사', '업계', '벽두', '시선', '가량', '준비', '판', '선전', '호', '웨이',
              '기존', '통해', '관련', '현재', '지난', '시장', '카','그룹', '행차', '기록', '백화점', '대비', '각'
              '대로', '전체', '고객', '공개', '서울', '이상', '아이오', '적용', '예정', '상황', '얘기', '정도', '안', '사실', '사람',
              '예스', '교수', '게임', '아이', '선', '대비', '며', '업종', '뉴시스', '서명', '바이', '산', '파이낸셜 뉴스', '자동차', '테슬라'
              ...
              '상황', '얘기', '정도', '안', '사실', '사람',  '경우', '재개', '부분', '가지', '계속', '오늘', '백봉', '삼', '노컷뉴스', '박선미',
              '왜', '회장', '박', '대해', '며', '영상', '자신', '에스', '명', '이메일', '사업자', '이미지', '출처', '연합뉴스', '비야디', '김민수',
              ...
              '인도', '경쟁', '데', '점유', '정보', '전략', '포드', '조사', '판매량', '분야', '솔루션', '제품', '지원', '이날', '국가', '협력', '지역', '주요', '일본', '역대',
              '분석', '방문', '너지', '핵심', '활용', '통신', '바', '대상', '스타', '관계자', '가운데', '수요', '정책', '인하', '법', '북미', '진행', '부품', '제조','부동산', 
              '뒤', '데이터', '확보', '포함', '메타', '삼성', '차지', '방식', '설립', '코리아', '소비자', '성능', '번', '지난달', '연구', '이익', '오픈', '규제', '수입', 
              '수출', '독일', '배', '기반', '폼', '강조', '강화', '벤츠', '우려', '정책', '인하', '법', '북미', '진행', '부품', '제조', '뒤', '데이터', '확보', '포함' ,'대통령실', 
              '메타', '삼성', '차지', '방식', '설립', '코리아', '소비자', '성능', '번', '지난달', '연구', '이익', '오픈', '규제', '수입', '수출', '독일', '배', '기반', '특파원',
              ...
              '리서치', '금지', '보유', '제외', '나라', '주도', '앱', '방안', '마련', '개인', '효과', '단계', '인간', '내년', '최초', '양산', '윤', '구조', '입장','항목',
              '한편', '상승', '시설', '빅', '본격', '합작', '도입', '안정', '기사', '국제', '공식', '중단', '자료', '전문가', '속', '제보', '설계', '다음', '억만', '법인', '테슬라'
              ...
              '달성', '전시', '메르세데스', '경향신문', '월간', '누리집', '인', '메', '구독', '부장', '딥', '틸', '일시', '량', '하반기', '량', '에서', '우선', '오바마']
...
def remove_korean_stopwords(nouns_list):
    return [[word for word in token if word not in stop_words] for token in nouns_list]

#한글 불용화 처리2 : 리스트안에 리스트
def remove_korean_stopword2(nouns_list):
