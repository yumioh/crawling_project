# 논문 구현 : LDA 주제 모델링으로 주제를 추출로 금융 시장 변동성 분석 <br/>
...
# 논문 분석
  ...
  - 논문 내용 : 
    - 주제 모델링과 회귀 분석을 결합한 방법론을 소개하여, 이를 통해 가장 관련성이 높은 뉴스를 식별하고, 큰 거래 이벤트의 상당 부분이 뉴스 흐름을 설명 될 수 있음
  ...
  - 논문 내용 기반으로 연구 방법 :
    ...
    3. 해당하는 토픽의 FVE와 FPE로 통해 뉴스가 주가에 미치는 영향을 확인
  - 연구 결론 :
    - 거래 활동에 미치는 총 715개의 중요한 주제 식별
    - 주식 시장에 영향을 주는 주요 토픽은 이익보고서, 신용등급, 합병거래 등이 있었고, 뉴스 정보는 주식 거래에 영향을 미침
<br>
